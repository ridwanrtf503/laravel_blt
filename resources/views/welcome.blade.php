...
-->
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('landing')}}/sassets/css/bootstrap.min.css">

    <link rel="stylesheet" type="text/css" href="{{asset('landing')}}/assets/css/font-awesome.css">

    <link rel="stylesheet" href="{{asset('landing')}}/assets/css/templatemo-softy-pinko.css">
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="#" class="logo">
                            <img src="{{asset('landing')}}/assets/images/logo.png" alt="Softy Pinko"/>
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li><a href="#welcome" class="active">Beranda</a></li>
                            <li><a href="landing/tentang#features">Tentang</a></li>
                            <li><a href="#work-process">Pengumuman</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                            <div class="features-small-item">
                                <div class="icon">
                                    <i><img src="{{asset('landing')}}/assets/images/featured-item-01.png" alt=""></i>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                        <a href="#" class="mini-box">
                            <i><img src="{{asset('landing')}}/assets/images/work-process-item-01.png" alt=""></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="team-item">
                        <div class="team-content">
                            <i><img src="{{asset('landing')}}/assets/images/testimonial-icon.png" alt=""></i>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="blog-post-thumb">
                        <div class="img">
                            <img src="{{asset('landing')}}/assets/images/blog-item-01.png" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="blog-post-thumb">
                        <div class="img">
                            <img src="{{asset('landing')}}/assets/images/blog-item-02.png" alt="">
                        </div>
                        <div class="blog-content">
                            <h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="blog-post-thumb">
                        <div class="img">
                            <img src="{{asset('landing')}}/assets/images/blog-item-03.png" alt="">
                        </div>
                        <div class="blog-content">
                            <h3>
